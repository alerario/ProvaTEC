...
public class Fornecedor implements Serializable {
    ...
    @Column(name = "nome")
    private String nome;
    @JoinTable(name = "prodforn", joinColumns = {
        @JoinColumn(name = "fornecedor", referencedColumnName = "idfornecedor")}, inverseJoinColumns = {
    ...
    public String toString() {
        return "br.data.entity.Fornecedor[ idfornecedor=" + idfornecedor + " ]";
    }
